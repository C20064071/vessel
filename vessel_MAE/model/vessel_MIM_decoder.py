...
class vessel_MIM_decoder(nn.Module):
    ...
    def forward_decoder(self, x, mask_ratio):
        ...
        return x, mask, ids_restore, feature
    ...
    def forward(self, imgs, fom):
        ...
        pred, mask, ids_restore, feature_decoder = self.forward_decoder(latent, self.mask_ratio)  # [N, L, p*p*3]
        mae_loss = self.forward_mae_loss(imgs, pred, mask)
        fom_loss = self.forward_fom_loss(feature_decoder,fom)
